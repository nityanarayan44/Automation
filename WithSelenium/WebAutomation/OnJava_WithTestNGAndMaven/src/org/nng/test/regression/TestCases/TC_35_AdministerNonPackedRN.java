...
public class TC_35_AdministerNonPackedRN extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_35_AdministerNonPackedRN";
	String testStep = "";
	...
	@Test(priority = 1)
	public void verifyNonPackedAdmin_RN()
	{
	...
	@Test(dependsOnMethods = "verifyNonPackedAdmin_RN")
