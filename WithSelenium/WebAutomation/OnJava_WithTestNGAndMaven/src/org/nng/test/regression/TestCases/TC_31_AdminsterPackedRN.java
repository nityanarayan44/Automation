...
public class TC_31_AdminsterPackedRN extends GetBrowserInstance
{
	WebDriver driver;
	...
	String vansahTestcaseName = "TC_31_AdminsterPackedRN";
	String testStep = "";
	...
	@Test(priority = 1)
	public void verifyPackedAdmin_RN()
	{
		...
		try
		{
			...
			if(homePage.verify_presenceOfOpenDoseRound(driver))
			{
				...
				testStep = "Click all checkboxes to administer packed medicine";
				residentPage.administerPackedMedicine(driver);
				vansah.sendUpdateLog(vansahPackage, vansahRequirement, vansahTestCaseID, vansahRelease, vansahBuild,
						bhs_Environment,"pass", "Test Step: " + testStep +" - Passed!", BHSLog_bit);			
	...
	@Test(dependsOnMethods = "verifyPackedAdmin_RN")
	public void verifyAdminsteredReport()
	{
		
		try
		{
			//residentName = "TESTPOINT, Eight";
