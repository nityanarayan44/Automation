...
public class TC_48_AdministerNonPckdVariable_byRN_byAIN extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_48_AdministerNonPckdVariable_byRN_byAIN";
	String testStep = "";
	
	String residentName ="TESTPOINT, Twelve";
	//String residentName ="";
	...
	@Test(priority = 1)
	public void administerNonPckdVariable_byRN_byAIN() 
	{
		...
		try
		{
			...
			if(homePage.verify_presenceOfOpenDoseRound(driver))
			{
				...
				if(residentPage.presence0f_PinAuthenticationPopUpLocated(driver)){
					...
					testStep = "User enters valid AIN pin from same facility  and click 'verify' for authorization";
	...
	@Test(dependsOnMethods = "administerNonPckdVariable_byRN_byAIN")
