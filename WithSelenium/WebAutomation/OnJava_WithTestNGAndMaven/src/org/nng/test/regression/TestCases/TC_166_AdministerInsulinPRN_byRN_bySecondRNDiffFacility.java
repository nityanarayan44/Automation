...
public class TC_166_AdministerInsulinPRN_byRN_bySecondRNDiffFacility extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_166_AdministerInsulinPRN_byRN_bySecondRNDiffFacility";
	String testStep = "";
	...
	@Test(priority = 1)
	public void administerInsulinPRN_byRN_bySecondRNDiffFacility() 
	{
		...
		try
		{
			...
			if(homePage.verify_presenceOfOpenDoseRound(driver))
			{
				...
				if(residentPage.presence0f_PinAuthenticationPopUpLocated(driver)){
					...
					testStep = "User enters RN pin of different facility and click 'verify' for authorization";
