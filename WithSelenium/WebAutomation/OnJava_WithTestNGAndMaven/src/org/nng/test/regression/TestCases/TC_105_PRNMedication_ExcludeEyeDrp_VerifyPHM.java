...
public class TC_105_PRNMedication_ExcludeEyeDrp_VerifyPHM  extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_105_PRNMedication_ExcludeEyeDrp_VerifyPHM";
	String testStep = "";
	...
	@Test(priority = 1)
	public void prnMedication_ExcludeEyeDrp() 
	{
		...
		try
		{
			...
			testStep = "User checks PRN and Exclude EyeDrops Checkboxes and unchecks Regular";
	...
	@Test(priority = 2, dependsOnMethods = {"prnMedication_ExcludeEyeDrp"})
