...
public class TC_124_AdministerInsulinPRN_byRN_byAIN extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_124_AdministerInsulinPRN_byRN_byAIN";
	String testStep = "";
	...
	@Test(priority = 1)
	public void administerInsulinPRN_byRN_byAIN() 
	{
		...
		try
		{
			...
			if(homePage.verify_presenceOfOpenDoseRound(driver))
			{
				...
				if(residentPage.presence0f_PinAuthenticationPopUpLocated(driver)){
					...
					testStep = "User enters valid second AIN pin from same facility  and click 'verify' for authorization";
	...
	@Test(dependsOnMethods = "administerInsulinPRN_byRN_byAIN")
