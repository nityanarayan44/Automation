...
public class TC_204_AdministerS8_asRN_byAgencyRN extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_204_AdministerS8_asRN_byAgencyRN";
	String testStep = "";
	...
	@Test(priority = 1)
	public void administerS8_asRN_byAgencyRN() 
	{
		...
		try
		{
			...
			if(homePage.verify_presenceOfOpenDoseRound(driver))
			{
				...
				key.click(driver, "xpath", "(//h3[contains(@ng-bind,'ResidentName')])[last()-2]");
				...
				testStep = "User verifies if the S8 Drug is present for the resident";
				...
				testStep = "User clicks to administer S8 Drug";
				...
				if(residentPage.presence0f_PinAuthenticationPopUpLocated(driver)){
					...
					//Enter steps for Entering Pin
					testStep = "User enters pin for Agency RN and click 'verify' for authorization";
					residentPage.enterPin(driver, Constants.Agency_RNPin);
	...
	@Test(dependsOnMethods = "administerS8_asRN_byAgencyRN")
