...
public class TC_161_Order_MnthEyeDropRegularPRN_VerifyInPHM  extends GetBrowserInstance
{
	WebDriver driver;
	...
	String vansahTestcaseName = "TC_161_Order_MnthEyeDropRegularPRN_VerifyInPHM";
	String testStep = "";
	...
	@Test(priority = 1)
	public void order_MnthEyeDropRegularPRN() 
	{
		...
		try
		{
			...
			testStep = "User checks Regular Checkbox";
	...
	@Test(priority = 2, dependsOnMethods = {"order_MnthEyeDropRegularPRN"})
