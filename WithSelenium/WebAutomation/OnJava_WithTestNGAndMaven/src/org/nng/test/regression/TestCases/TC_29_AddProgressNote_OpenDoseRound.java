...
public class TC_29_AddProgressNote_OpenDoseRound extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_29_AddProgressNote_OpenDoseRound";
	String testStep = "";

	//String residentName ="TESTPOINT, Eight";
	String residentName ="";
	String drugName = "";
	String progNote_Text = "This is dummy Note from Automation Script";
	...
	@Test(priority = 1)
	public void addProgressNote_OpenDoseRound() 
	{
	...
	@Test(dependsOnMethods = "addProgressNote_OpenDoseRound")
