...
public class TC_188_AdministerS8_byAIN_SecondAINPin extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_188_AdministerS8_byAIN_DiffFacilityAINPin";
	String testStep = "";
	...
	@Test(priority = 1)
	public void administerS8_byAIN_InvalidPin() 
	{
		...
		try
		{
			...
			if(homePage.verify_presenceOfOpenDoseRound(driver))
			{
				...
				if(residentPage.presence0f_PinAuthenticationPopUpLocated(driver)){
					...
					testStep = "User enters AIN pin from Same Facility and click 'verify' for authorization";
