...
public class TC_178_AdministerNonPckdVariable_byRN_byDiffFacilityAIN extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_178_AdministerNonPckdVariable_byRN_byDiffFacilityAIN";
	String testStep = "";
	...
	@Test(priority = 1)
	public void administerNonPckdVariable_byRN_byDiffFacilityAIN() 
	{
		...
		try
		{
			...
			if(homePage.verify_presenceOfOpenDoseRound(driver))
			{
				...
				if(residentPage.presence0f_PinAuthenticationPopUpLocated(driver)){
					...
					testStep = "User enters valid AIN pin from different facility  and click 'verify' for authorization";
