...
public class TC_54_AdministerNonPackedPRN_byRN extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_54_AdministerNonPackedPRN_byRN";
	String testStep = "";
	...
	@Test(priority = 1)
	public void administerNonPackedPRN_byRN() 
	{
		...
		try
		{
			...
			if(homePage.verify_presenceOfOpenDoseRound(driver))
			{
				...
				if(residentPage.presence0f_PinAuthenticationPopUpLocated(driver)){
					...
					testStep = "User enters AIN pin and click 'verify' for authorization";
	...
	@Test(dependsOnMethods = "administerNonPackedPRN_byRN")
