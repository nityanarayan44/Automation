...
public class TC_203_AdministerS8_asRN_byAgencyAIN extends GetBrowserInstance
{
	WebDriver driver;
	...
	String vansahTestcaseName = "TC_203_AdministerS8_asRN_byAgencyAIN";
	String testStep = "";

	String residentName ="TESTPOINT, Six";
	//String residentName ="";
	...
	@Test(priority = 1)
	public void administerS8_asRN_byAgencyAIN() 
	{
		...
		try
		{
			...
			if(homePage.verify_presenceOfOpenDoseRound(driver))
			{
				...
				if(residentPage.presence0f_PinAuthenticationPopUpLocated(driver)){
					...
					testStep = "User enters pin for Agency AIN and click 'verify' for authorization";
					residentPage.enterPin(driver, Constants.Agency_AINPin);
	...
	@Test(dependsOnMethods = "administerS8_asRN_byAgencyAIN")
