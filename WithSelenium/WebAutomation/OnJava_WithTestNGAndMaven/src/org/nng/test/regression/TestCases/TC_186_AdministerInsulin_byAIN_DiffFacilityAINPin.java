...
public class TC_186_AdministerInsulin_byAIN_DiffFacilityAINPin extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_186_AdministerS8_byAIN_DiffFacilityAINPin";
	String testStep = "";
	...
	@Test(priority = 1)
	public void administerS8_byAIN_DiffFacilityAINPin() 
	{
		...
		try
		{
			...
			if(homePage.verify_presenceOfOpenDoseRound(driver))
			{
				...
				if(residentPage.presence0f_PinAuthenticationPopUpLocated(driver)){
					...
					testStep = "User enters pin of AIN from different Facility and click 'verify' for authorization";
