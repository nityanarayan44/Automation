...
public class TC_24_AdministerNIM_asAIN_byRN extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_24_AdministerNIM_asAIN_byRN";
	String testStep = "";
	...
	@Test(priority = 1)
	public void administerNIM_asAIN_byRN() 
	{
		...
		try
		{
			...
			if(homePage.verify_presenceOfOpenDoseRound(driver))
			{
				...
				residentPage.enterNIM_AdminQty(driver);
				vansah.sendUpdateLog(vansahPackage, vansahRequirement, vansahTestCaseID, vansahRelease, vansahBuild,
						bhs_Environment,"pass", "Test Step: " + testStep +" - Passed!", BHSLog_bit);


				//Fetch drugName
				drugName = residentPage.getDrugName_NIM(driver);
	...
	@Test(dependsOnMethods = "administerNIM_asAIN_byRN")
	...
	public void verifyAdminsteredReport()
	{
		...
		try
		{
			...
			testStep = "User unchecks PRN, Emergency and checks NIM";
