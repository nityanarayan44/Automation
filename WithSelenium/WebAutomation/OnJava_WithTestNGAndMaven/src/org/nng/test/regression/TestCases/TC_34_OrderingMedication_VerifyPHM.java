...
public class TC_34_OrderingMedication_VerifyPHM extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_34_OrderingMedication_VerifyPHM";
	String testStep = "";
	...
	@Test(priority = 1)
	public void orderingMedication_VerifyPHM() 
	{
		...
		try
		{
			...
			testStep = "User checks Regular and unchecks PRN, Exclude EyeDrops Checkboxes";
	...
	@Test(priority = 2, dependsOnMethods = {"orderingMedication_VerifyPHM"})
