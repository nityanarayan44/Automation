...
public class TC_55_AdministerInsulinPRN_byRN_bySecondRN  extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_55_AdministerInsulinPRN_byRN_bySecondRN";
	String testStep = "";
	...
	@Test(priority = 1)
	public void administerInsulinPRN_byRN_bySecondRN() 
	{
		...
		try
		{
			...
			if(homePage.verify_presenceOfOpenDoseRound(driver))
			{
				...
				key.click(driver, "xpath", "(//h3[contains(@ng-bind,'ResidentName')])[3]");
				...
				if(residentPage.presence0f_PinAuthenticationPopUpLocated(driver)){
					...
					testStep = "User enters valid second RN pin from same facility  and click 'verify' for authorization";
					residentPage.enterPin(driver, Constants.RN_PIN2_FromSameFacility);
	...
	@Test(dependsOnMethods = "administerInsulinPRN_byRN_bySecondRN")
