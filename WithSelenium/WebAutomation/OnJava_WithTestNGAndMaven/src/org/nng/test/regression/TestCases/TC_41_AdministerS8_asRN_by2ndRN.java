...
public class TC_41_AdministerS8_asRN_by2ndRN extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_41_AdministerS8_asRN_by2ndRN";
	String testStep = "";
	...
	@Test(priority = 1)
	public void administerS8_asRN_by2ndRN() 
	{
		...
		try
		{
			...
			if(homePage.verify_presenceOfOpenDoseRound(driver))
			{
				...
				if(residentPage.presence0f_PinAuthenticationPopUpLocated(driver)){
					...
					testStep = "User enters RN pin from another facility and click 'verify' for authorization";
	...
	@Test(dependsOnMethods = "administerS8_asRN_by2ndRN")
