...
public class TC_197_AdministerPackedAIN_byRN extends GetBrowserInstance
{
	WebDriver driver;
	...
	String vansahTestcaseName = "TC_197_AdministerPackedAIN_byRN";
	String testStep = "";
	
	String residentName ="";
	//String residentName ="TESTPOINT, Four";
	...
	@Test(priority = 1)
	public void verifyPackedAdminAIN_byRN() 
	{
		...
		try
		{
			...
			if(homePage.verify_presenceOfOpenDoseRound(driver))
			{
				...
				testStep = "User click on RN checkbox for Packed medicine and verify it by entering RN pin";
				if(residentPage.administerPackedMedicine_AsAIN(driver, Constants.RN_PIN)){
					vansah.sendUpdateLog(vansahPackage, vansahRequirement, vansahTestCaseID, vansahRelease, vansahBuild,
							bhs_Environment,"pass", "Test Step: " + testStep +" - Passed!", BHSLog_bit);	
				}else{
	...
	@Test(dependsOnMethods = "verifyPackedAdminAIN_byRN")
