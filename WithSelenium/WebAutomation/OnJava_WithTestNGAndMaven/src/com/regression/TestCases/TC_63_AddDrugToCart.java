...
public class TC_63_AddDrugToCart extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_63_AddDrugTocCart";
	String testStep = "";
	...
	@Test(dependsOnMethods = "addDrugToCart", alwaysRun = true)
