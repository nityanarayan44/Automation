...
public class TC_177_AdministerPckdVariable_asRN extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_177_AdministerPckdVariable_asRN";
	String testStep = "";
	...
	@Test(priority = 1)
	public void administerPckdVariable_asRN() 
	{
		...
		try
		{
			...
			if(homePage.verify_presenceOfOpenDoseRound(driver))
			{
				...
				testStep="User verifies presence of Variable drug in Packed Section";
				if(residentPage.presence0fPacked_VariableDrugLocated(driver)){
					vansah.sendUpdateLog(vansahPackage, vansahRequirement, vansahTestCaseID, vansahRelease, vansahBuild,
							bhs_Environment,"pass", "Test Step: " + testStep +" - Passed!", BHSLog_bit);

					testStep = "User click to administer the Packed Variable drug";
					residentPage.clickOn_PackedVariableDrug(driver);
					vansah.sendUpdateLog(vansahPackage, vansahRequirement, vansahTestCaseID, vansahRelease, vansahBuild,
							bhs_Environment,"pass", "Test Step: " + testStep +" - Passed!", BHSLog_bit);
					
				}// end of Variable Drug condition
				else{
	...
	@Test(dependsOnMethods = "administerPckdVariable_asRN")
