...
public class TC_59_Order_MnthEyeDrop_Medication_VerifyInPHM extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_59_Order_MnthEyeDrop_Medication_VerifyInPHM";
	String testStep = "";
	//String textDummy = "This is dummy text from Automation Script 59";
	...
	@Test(priority = 1)
	public void orderMnthEyeDrop_Medication() 
	{
		...
		try
		{
			...
			testStep = "User Clicks on Monthly Eye Drops Menu";
			orderPage.clickOn_MonthlyEyeDrop(driver);
			vansah.sendUpdateLog(vansahPackage, vansahRequirement, vansahTestCaseID, vansahRelease, vansahBuild,
					bhs_Environment,"pass", "Test Step: " + testStep +" - Passed!", BHSLog_bit);
			...
			testStep = "User checks PRN Checkbox";
			...
			testStep = "User verifies the presence of EyeDrops medication in the searched list";
	...
	@Test(priority = 2, dependsOnMethods = {"orderMnthEyeDrop_Medication"})
	public void verifyInBestPack()
	{
		try
		{
			...
			testStep ="User selects Monthly EyeDrops Type and click on Search button";
			Facility.clickOnStatus_All(driver);
			Facility.clickOnType_MonthlyEyeDrop(driver);
