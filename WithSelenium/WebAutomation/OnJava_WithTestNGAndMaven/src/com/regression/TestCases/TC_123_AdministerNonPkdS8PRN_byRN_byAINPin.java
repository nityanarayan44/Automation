...
public class TC_123_AdministerNonPkdS8PRN_byRN_byAINPin extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_123_AdministerNonPkdS8PRN_byRN_byAINPin";
	String testStep = "";
	
	String residentName ="TESTPOINT, Two";
	//String residentName ="";
	...
	@Test(priority = 1)
	public void administerNonPkdS8PRN_byRN_byAINPin() 
	{
		...
		try
		{
			...
			if(homePage.verify_presenceOfOpenDoseRound(driver))
			{
				...
				if(residentPage.presence0f_PinAuthenticationPopUpLocated(driver)){
					...
					testStep = "User enters valid second AIN pin and click 'verify' for authorization";
	...
	@Test(dependsOnMethods = "administerNonPkdS8PRN_byRN_byAINPin")
