...
public class TC_21_AdministerPackedAIN extends GetBrowserInstance 
{
	...
	String vansahTestcaseName = "TC_21_AdministerPackedAIN";
	String testStep = "";
	
	String residentName ="TESTPOINT, Tone";
	//String residentName ="";
	...
	@Test(priority = 1)
	public void verifyPackedAdminAIN() 
	{
	...
	@Test(dependsOnMethods = "verifyPackedAdminAIN")
