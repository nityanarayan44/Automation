...
public class TC_196_AdministerPackedAINReason extends GetBrowserInstance 
{
	...
	String vansahTestcaseName = "TC_196_AdministerPackedAINReason";
	String testStep = "";
	...
	@Test(priority = 1)
	public void verifyPackedAdminAIN_Reason() 
	{
		...
		try
		{
			...
			if(homePage.verify_presenceOfOpenDoseRound(driver))
			{
				...
				//Select reasons
				testStep = "User selects a number of given reason to administer all packed medicines";
				residentPage.selectNumGivenReason(driver, "Self Administered");
				vansah.sendUpdateLog(vansahPackage, vansahRequirement, vansahTestCaseID, vansahRelease, vansahBuild,
						bhs_Environment,"pass", "Test Step: " + testStep +" - Passed!", BHSLog_bit);
	...
	@Test(dependsOnMethods = "verifyPackedAdminAIN_Reason")
