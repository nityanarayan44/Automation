...
public class TC_172_AdministerNonPackedS8PRN_byAIN_2RNPin extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_172_AdministerNonPackedS8PRN_byAIN_2RNPin";
	String testStep = "";
	...
	@Test(priority = 1)
	public void administerNonPackedS8PRN_byAIN_2RNPin() 
	{
	...
	@Test(dependsOnMethods = "administerNonPackedS8PRN_byAIN_2RNPin")
