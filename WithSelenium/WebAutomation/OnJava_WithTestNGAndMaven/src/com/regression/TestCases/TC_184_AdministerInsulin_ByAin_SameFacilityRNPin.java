...
public class TC_184_AdministerInsulin_ByAin_SameFacilityRNPin extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_184_AdministerInsulin_ByAin_SameFacilityRNPin";
	String testStep = "";
	...
	@Test(priority = 1)
	public void administerInsulin_ByAin_SameFacilityRNPin() 
	{
		...
		try
		{
			...
			if(homePage.verify_presenceOfOpenDoseRound(driver))
			{
				...
				key.click(driver, "xpath", "(//h3[contains(@ng-bind,'ResidentName')])[last()-3]");
	...
	@Test(dependsOnMethods = "administerInsulin_ByAin_SameFacilityRNPin")
