...
public class TC_183_AdministerInsulin_DiffFacilityRNPin extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_183_AdministerInsulin_DiffFacilityRNPin";
	String testStep = "";
	...
	@Test(priority = 1)
	public void administerInsulin_DiffFacilityRNPin() 
	{
		...
		try
		{
			...
			if(homePage.verify_presenceOfOpenDoseRound(driver))
			{
				...
				if(residentPage.presence0f_PinAuthenticationPopUpLocated(driver)){
					...
					testStep = "User enters pin of RN from different Facility and click 'verify' for authorization";
