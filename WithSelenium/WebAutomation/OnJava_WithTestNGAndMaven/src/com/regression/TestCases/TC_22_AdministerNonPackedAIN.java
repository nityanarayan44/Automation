...
public class TC_22_AdministerNonPackedAIN extends GetBrowserInstance
{
	WebDriver driver;
	...
	String vansahTestcaseName = "TC_22_AdministerNonPackedAIN";
	String testStep = "";
	...
	@Test(priority = 1)
	public void verifyNonPackedAdminAIN() 
	{
		...
		try
		{
			...
			if(homePage.verify_presenceOfOpenDoseRound(driver))
			{
				...
				//-- click on Packed Tab;
				testStep = "User Clicks on NonPacked Tab";
				...
				testStep = "Click all checkboxes under Non-packed medicine";
				residentPage.administerNonPackedMedicine(driver);
				vansah.sendUpdateLog(vansahPackage, vansahRequirement, vansahTestCaseID, vansahRelease, vansahBuild,
						bhs_Environment,"pass", "Test Step: " + testStep +" - Passed!", BHSLog_bit);
				Thread.sleep(1000);
				...
				//check if there is a confirmation popup
				...
				}// end of confirmation popup logic
	...
	@Test(dependsOnMethods = "verifyNonPackedAdminAIN")
