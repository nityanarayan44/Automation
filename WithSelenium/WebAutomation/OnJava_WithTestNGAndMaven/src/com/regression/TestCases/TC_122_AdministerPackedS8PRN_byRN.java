...
public class TC_122_AdministerPackedS8PRN_byRN extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_122_AdministerPackedS8PRN_byRN";
	String testStep = "";
	...
	@Test(priority = 1)
	public void administerPackedS8PRN_byRN() 
	{
		...
		try
		{
			...
			if(homePage.verify_presenceOfOpenDoseRound(driver))
			{
				...
				testStep = "User verifies if the S8 Drug is present in Packed section for the resident";
				if(residentPage.presence0fPackedMedicine_S8Located(driver))
				{
					vansah.sendUpdateLog(vansahPackage, vansahRequirement, vansahTestCaseID, vansahRelease, vansahBuild,
							bhs_Environment,"pass", "Test Step: " + testStep +" - Passed!", BHSLog_bit);
				...
				residentPage.enterPkdS8QTY_PRN(driver, "-1"); // Always enter -ve value to check notification message
				vansah.sendUpdateLog(vansahPackage, vansahRequirement, vansahTestCaseID, vansahRelease, vansahBuild,
						bhs_Environment,"pass", "Test Step: " + testStep +" - Passed!", BHSLog_bit);
				
				//Check to Administer Medicine
				testStep = "User click on Admin checkbox to administer the S8 medicine";
				residentPage.clickOn_PackedAdminS8(driver);
				vansah.sendUpdateLog(vansahPackage, vansahRequirement, vansahTestCaseID, vansahRelease, vansahBuild,
						bhs_Environment,"pass", "Test Step: " + testStep +" - Passed!", BHSLog_bit);
	...
	@Test(dependsOnMethods = "administerPackedS8PRN_byRN")
