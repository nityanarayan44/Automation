...
public class TC_23_AdministerNIM_byRN extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_23_AdministerNIM_byRN";
	String testStep = "";
	...
	@Test(priority = 1)
	public void administerNIM_byRN() 
	{
	...
	@Test(dependsOnMethods = "administerNIM_byRN")
