...
public class TC_192_AdministerS8_byRN extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_192_AdministerS8_byRN";
	String testStep = "";
	...
	//String residentName ="TESTPOINT, Five";
			...
			try
			{
				...
				if(homePage.verify_presenceOfOpenDoseRound(driver))
				{
					...
					if(residentPage.presence0f_PinAuthenticationPopUpLocated(driver)){
						...
						//Enter steps for valid Pin
						testStep = "User enters valid AIN pin and click 'verify' for authorization";
		...
		@Test(dependsOnMethods = "administerS8_byRN")
