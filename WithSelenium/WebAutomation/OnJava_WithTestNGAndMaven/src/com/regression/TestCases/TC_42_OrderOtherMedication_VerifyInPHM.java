...
public class TC_42_OrderOtherMedication_VerifyInPHM extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_42_OrderOtherMedication_VerifyInPHM";
	String testStep = "";
	String textDummy = "This is dummy text from Automation Script 42";
	...
	@Test(priority = 1)
	public void orderOtherMedication() 
	{
		...
		try
		{
			...
			testStep = "User Clicks on Others Menu";
			orderPage.clickOn_Other(driver);
			vansah.sendUpdateLog(vansahPackage, vansahRequirement, vansahTestCaseID, vansahRelease, vansahBuild,
					bhs_Environment,"pass", "Test Step: " + testStep +" - Passed!", BHSLog_bit);
	...
	@Test(priority = 2, dependsOnMethods = {"orderOtherMedication"})
	public void verifyInBestPack()
	{
		try
		{
			...
			testStep ="User selects Other Type and click on Search button";
			Facility.clickOnType_Other(driver);
