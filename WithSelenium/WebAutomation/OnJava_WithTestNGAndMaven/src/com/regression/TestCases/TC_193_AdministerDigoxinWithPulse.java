...
public class TC_193_AdministerDigoxinWithPulse extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_193_AdministerDigoxinWithPulse";
	String testStep = "";
	...
	@Test(priority = 1)
	public void administerDigoxinWithPulse() 
	{
		...
		try
		{
			...
			if(homePage.verify_presenceOfOpenDoseRound(driver))
			{
				...
				testStep = "User verifies if the Digoxin is present in Packed section for the resident";
				if(residentPage.presence0fPackedMedicine_DIGOXINLocated(driver))
				{
					vansah.sendUpdateLog(vansahPackage, vansahRequirement, vansahTestCaseID, vansahRelease, vansahBuild,
							bhs_Environment,"pass", "Test Step: " + testStep +" - Passed!", BHSLog_bit);
					...
					vansah.sendUpdateLog(vansahPackage, vansahRequirement, vansahTestCaseID, vansahRelease, vansahBuild,
							bhs_Environment,"fail", "There is no Digoxin medicine available for the test :( Unable to procceed. ", BHSLog_bit);
				...
				/*testStep = "User clicks to adminsiter Digoxin for the resident";
				residentPage.clickOn_AdminDIGOXIN(driver);
				vansah.sendUpdateLog(vansahPackage, vansahRequirement, vansahTestCaseID, vansahRelease, vansahBuild,
						bhs_Environment,"pass", "Test Step: " + testStep +" - Passed!", BHSLog_bit);
				...
				*/
				...
				testStep = "User verifies the presence of pulse required popup";
				if(residentPage.presence0f_PulseRequiredPopUpLocated(driver)){
					vansah.sendUpdateLog(vansahPackage, vansahRequirement, vansahTestCaseID, vansahRelease, vansahBuild,
							bhs_Environment,"pass", "Test Step: " + testStep +" - Passed!", BHSLog_bit);
					...
					testStep = "User Confirms to Record pulse";
					residentPage.confirm_POPUP(driver);
					vansah.sendUpdateLog(vansahPackage, vansahRequirement, vansahTestCaseID, vansahRelease, vansahBuild,
							bhs_Environment,"pass", "Test Step: " + testStep +" - Passed!", BHSLog_bit);	
				}// end of pulse required logic
				else{
					ScreenShotCapture.captureScreen(driver, vansahTestcaseName);
					vansah.sendUpdateLog(vansahPackage, vansahRequirement, vansahTestCaseID, vansahRelease, vansahBuild,
							bhs_Environment,"fail", "Test Step: " + testStep +" - Failed!", BHSLog_bit);
	...
	@Test(dependsOnMethods = "administerDigoxinWithPulse")
