...
public class TC_45_Order_MnthEyeDropRegular_VerifyInPHM extends GetBrowserInstance
{
	WebDriver driver;
	...
	String vansahTestcaseName = "TC_45_Order_MnthEyeDropRegular_VerifyInPHM";
	String testStep = "";
	...
	@Test(priority = 1)
	public void order_MnthEyeDropRegular() 
	{
	...
	@Test(priority = 2, dependsOnMethods = {"order_MnthEyeDropRegular"})
