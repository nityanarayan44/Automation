...
public class TC_179_AdministerNonPckdVariable_byRN_bySecondRN extends GetBrowserInstance
{
	...
	String vansahTestcaseName = "TC_179_AdministerNonPckdVariable_byRN_bySecondRN";
	String testStep = "";
	...
	@Test(priority = 1)
	public void administerNonPckdVariable_byRN_bySecondRN() 
	{
		...
		try
		{
			...
			if(homePage.verify_presenceOfOpenDoseRound(driver))
			{
				...
				if(residentPage.presence0f_PinAuthenticationPopUpLocated(driver)){
					...
					testStep = "User enters valid RN pin from same facility  and click 'verify' for authorization";
	...
	@Test(dependsOnMethods = "administerNonPckdVariable_byRN_bySecondRN")
