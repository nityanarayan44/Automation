...
public class TC_189_AdministerS8_byAIN_DiffFacilityRNPin extends GetBrowserInstance
{
	WebDriver driver;
	...
	String vansahTestcaseName = "TC_189_AdministerS8_byAIN_InvalidPin";
	String testStep = "";
		...
		try
		{
			...
			if(homePage.verify_presenceOfOpenDoseRound(driver))
			{
				...
				if(residentPage.presence0f_PinAuthenticationPopUpLocated(driver)){
					...
					testStep = "User enters RN pin from different Facility and click 'verify' for authorization";
